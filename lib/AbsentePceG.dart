...
class _ChecklistPageState extends State<ChecklistPage> {
 ...
 Future<void> saveCheckedStudentsToFirestore() async {
  try {
    ...
    DocumentReference documentRef = _firestore.collection('checkedStudentsPceG').doc(today);
    ...
    if (documentExists) {
      ...
      documentRef = _firestore.collection('checkedStudentsPceG').doc('$today-$timestamp');
    }
