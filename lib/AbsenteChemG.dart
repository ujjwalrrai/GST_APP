...
class AbsenteChemG extends StatelessWidget {
  @override
...
class _ChecklistPageState extends State<ChecklistPage> {
 ...
 Future<void> saveCheckedStudentsToFirestore() async {
  try {
    ...
    DocumentReference documentRef = _firestore.collection('checkedStudentsChem').doc(today);
    ...
    if (documentExists) {
      ...
      documentRef = _firestore.collection('checkedStudentsChem').doc('$today-$timestamp');
    }
