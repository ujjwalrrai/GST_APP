...
class AbsenteMathG extends StatelessWidget {
  @override
...
class _ChecklistPageState extends State<ChecklistPage> {
 ...
 Future<void> saveCheckedStudentsToFirestore() async {
  try {
    ...
    DocumentReference documentRef = _firestore.collection('checkedStudentsMaths').doc(today);
    ...
    if (documentExists) {
      ...
      documentRef = _firestore.collection('checkedStudentsMaths').doc('$today-$timestamp');
    }
...
class _StudentItemState extends State<StudentItem> {
  ...
  Future<int> getPresent(String documentId) async {
    try {
      ...
      int present = snapshot.get('presentMATHS2');
      return present;
    } catch (e) {
